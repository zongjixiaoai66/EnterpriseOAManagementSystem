        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="日志信息详情" prop="gerenbianqianContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gerenbianqianContent" label="日志信息详情" prop="gerenbianqianContent">
