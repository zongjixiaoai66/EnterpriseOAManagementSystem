  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='岗位' prop="gangweiTypes">
                 <el-select v-model="ruleForm.gangweiTypes"  placeholder='请选择岗位'>
                     <el-option
...
// 注册表 用户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.gangweiTypes)&& 'yonghu'==this.flag){
